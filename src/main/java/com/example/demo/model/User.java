...
@NamedQueries({
        ...
        @NamedQuery(name = "User.getAllAdminUsers",
                query = "SELECT u from User u where u.role = com.example.demo.model.Role.ADMIN_ROLE"),
        @NamedQuery(name = "User.getAllCustomerUsers",
                query = "SELECT u from User u where u.role = com.example.demo.model.Role.CUSTOMER_ROLE"),
